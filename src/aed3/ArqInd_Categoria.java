...
public class ArqInd_Categoria<Categoria extends Registro> {
    ...
    public ArqInd_Categoria(String na, String n1, String n2) throws Exception {
        nomeArquivo = na;
    ...
    public int incluir( Categoria obj ) throws IOException {    //incluir um objeto
        arquivoDados.seek(0);
    ...
    public boolean buscar(int codigo, Categoria obj) throws Exception {
        
        long endereco = localiza(codigo,obj);
        return endereco!=-1;
    }
    
    public long localiza(int codigo, Categoria obj) throws Exception {
    ...
    public boolean buscarString(String stringDeBusca, Categoria obj) throws Exception {
    ...
    public boolean excluir(int codigo, Categoria obj) throws Exception {
        long endereco = localiza(codigo,obj);
        if( endereco==-1 )
            return false;
    ...
    public boolean alterar(int codigo, Categoria obj, Categoria objAlterado) throws Exception {
        long endereco = localiza(codigo,obj);
        if( endereco==-1  )
            return false;
    ...
    public boolean proximo(Categoria obj) throws Exception {
...
*/
    ...
    public void reorganizar(Categoria obj) throws Exception {
        ...
        // ---------------------------------------------------------------------
        List<Categoria> registrosOrdenados = new ArrayList<>();
        int    contador=0, seletor=0;
        int    tamanho;
        byte   lapide;
        byte[] dados;
        Categoria   r1 = (Categoria)obj.clone(),
                    r2 = (Categoria)obj.clone(),
                    r3 = (Categoria)obj.clone();
        Categoria rAnt1, rAnt2, rAnt3;
        ...
        try{ 
            ...
            while(true) {
                ...
                if(lapide == ' ') {
                    registrosOrdenados.add((Categoria)r1.clone());
                    contador++;
                }
                if(contador==tamanhoBlocoMemoria){
                    ...
                    for( Categoria r: registrosOrdenados ) {
                        dados = r.getRegistro();
