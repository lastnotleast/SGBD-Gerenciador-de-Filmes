...
public class ArqInd_Elenco<Elenco extends Registro> {
    ...
    public ArqInd_Elenco(String na, String n1, String n2) throws Exception {
        nomeArquivo = na;
    ...
    public int incluir( Elenco obj ) throws IOException {    //incluir um objeto
        arquivoDados.seek(0);
    ...
    public boolean buscar(int codigo, Elenco obj) throws Exception {
        
        long endereco = localiza(codigo,obj);
        return endereco!=-1;
    }
    
    public long localiza(int codigo, Elenco obj) throws Exception {
    ...
    public boolean buscarString(String stringDeBusca, Elenco obj) throws Exception {
    ...
    public boolean excluir(int codigo, Elenco obj) throws Exception {
        long endereco = localiza(codigo,obj);
        if( endereco==-1 )
            return false;
    ...
    public boolean alterar(int codigo, Elenco obj, Elenco objAlterado) throws Exception {
        long endereco = localiza(codigo,obj);
        if( endereco==-1  )
            return false;
    ...
    public boolean proximo(Elenco obj) throws Exception {
...
*/
    ...
    public void reorganizar(Elenco obj) throws Exception {
        ...
        // ---------------------------------------------------------------------
        List<Elenco> registrosOrdenados = new ArrayList<>();
        int    contador=0, seletor=0;
        int    tamanho;
        byte   lapide;
        byte[] dados;
        Elenco  r1 = (Elenco)obj.clone(),
                r2 = (Elenco)obj.clone(),
                r3 = (Elenco)obj.clone();
        Elenco rAnt1, rAnt2, rAnt3;
        ...
        try{ 
            ...
            while(true) {
                ...
                if(lapide == ' ') {
                    registrosOrdenados.add((Elenco)r1.clone());
                    contador++;
                }
                if(contador==tamanhoBlocoMemoria){
                    ...
                    for( Elenco r: registrosOrdenados ) {
                        dados = r.getRegistro();
